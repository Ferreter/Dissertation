...
The highest observed development-period enrichment for a 30+ bps move among rules retaining at least 10 sessions was 2.88x (10 sessions) under 'All three with RQ2 >= 25 bps'. Because this rule is identified from development-period diagnostics, it should not be interpreted as independently confirmed.
